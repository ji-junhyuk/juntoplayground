...
//        DiscountPolicy bean = ac.getBean(MemberRepository.class);
    ...
    @Test
    @DisplayName("When searching by type, if there is more than one type of the same type, you can specify an empty name.")
    void findBeanByName() {
    ...
    @Test
    @DisplayName("Retrieving all specific types")
